...
export async function generateMetadata({ params, searchParams }, parent) {
    ...
    // fetch data
    const data = await getSinglePostData(slug, "/wp-json/wp/v2/residential-cleaning")
...
export default async function Contact({ params }) {
    ...
    const postData = await getSinglePostData(slug, "/wp-json/wp/v2/residential-cleaning")
